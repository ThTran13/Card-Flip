// The cards are shuffled three times.
// The player draws 24 cards from the top of the deck, without looking at them, and places
// them face down on the table.
// The player can either select a card to turn over, or end the game. If a card is turned over, the player:
...
// A player’s goal is to end the game with the most points.
